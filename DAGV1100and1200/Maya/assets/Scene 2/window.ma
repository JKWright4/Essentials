...
//Name: window.ma
//Last modified: Mon, Apr 20, 2026 01:43:46 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "1A5CD2A9-4126-21FC-629F-849904A2E049";
...
createNode transform -n "pCube15" -p "reference_cubes";
	...
	setAttr ".t" -type "double3" -0.83248774950169313 1.579253867302604 0 ;
	setAttr ".s" -type "double3" 3.1585074551590822 3.1585074551590822 3.1585074551590822 ;
	setAttr ".rp" -type "double3" 0.83248774950169313 -1.579253867302604 0 ;
	setAttr ".sp" -type "double3" 0.26356998085975647 -0.50000004423705335 0 ;
	setAttr ".spt" -type "double3" 0.56891776864193666 -1.0792538230655504 0 ;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 18.728529364916671 10.04451452962161 2.3490803578096049 ;
	setAttr ".r" -type "double3" -19.20000000000028 441.59999999995046 -1.0886119738700705e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 21.038316850470078;
...
createNode mesh -n "pCubeShape17" -p "pCube17";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.625 0.61250001192092896 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "19ADE150-4FFC-7F5A-5813-E1A13FC8832B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F8FBD67D-4805-C0B2-3FEA-6EA25313CC37";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "55645C3B-4378-52DB-32BF-968C48630285";
createNode displayLayerManager -n "layerManager";
	rename -uid "E5DDC239-4001-6795-A3FA-F8AFDA8D7F18";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "140B754C-4DBE-6024-AE0A-DAAC795A8A8A";
...
createNode polyTweak -n "polyTweak2";
	...
	setAttr ".uopa" yes;
	setAttr -s 23 ".tk";
	setAttr ".tk[36]" -type "float3" -0.0039345124 0.014236405 0.017920151 ;
	setAttr ".tk[37]" -type "float3" 0.076847345 0.014236405 0.017920151 ;
	setAttr ".tk[38]" -type "float3" 0.076847345 0.014236405 -0.017920151 ;
	setAttr ".tk[39]" -type "float3" -0.0039345124 0.014236405 -0.017920151 ;
	setAttr ".tk[40]" -type "float3" 0.076847345 -0.0063013732 0.014586806 ;
	setAttr ".tk[41]" -type "float3" 0.076847345 -0.0063013732 -0.014586806 ;
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[0]" -type "float3" 0 -0.027107086 0 ;
	setAttr ".tk[1]" -type "float3" 0 -0.027107086 0 ;
	setAttr ".tk[2]" -type "float3" 0 0.062376093 0 ;
	setAttr ".tk[3]" -type "float3" 0 0.062376093 0 ;
	setAttr ".tk[4]" -type "float3" 0 0.062376093 0 ;
	setAttr ".tk[5]" -type "float3" 0 0.062376093 0 ;
	setAttr ".tk[6]" -type "float3" 0 -0.027107086 0 ;
	setAttr ".tk[7]" -type "float3" 0 -0.027107086 0 ;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "2F2462BE-4CAC-4F3D-19AF-2682E9624E82";
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "layer1.di" "pCube15.do";
connectAttr "polyCube10.out" "pCubeShape15.i";
connectAttr "deleteComponent6.og" "pCubeShape16.i";
connectAttr "deleteComponent5.og" "pCubeShape17.i";
...
connectAttr "pCubeShape17.wm" "polyExtrudeFace5.mp";
