...
//Name: RoomScene.ma
//Last modified: Wed, Feb 11, 2026 10:54:23 AM
//Codeset: 1252
...
fileInfo "UUID" "EE457668-43DF-AFD5-5B67-5CBC4CE66BF3";
createNode transform -s -n "persp";
	rename -uid "2340ED71-4C42-971C-62FE-75A5C06857A7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 43.754692857300221 30.680347668056029 49.414925360762638 ;
	setAttr ".r" -type "double3" -20.40000000000018 40.000000000000092 -1.0379798163255961e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 61.782972305232619;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A427B2AE-4797-C35F-6872-1A8C381E5CB6";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "ABA185D4-499A-3030-0235-78B6E084F56C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9692AF8E-426E-DF08-DBFE-8FAD951F13AC";
createNode displayLayerManager -n "layerManager";
	rename -uid "1049AA2D-481B-9276-06E4-C1973868AFB4";
	setAttr ".cdl" 2;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C38CD8C0-4EDE-E194-7377-FEB6F4F7F31A";
...
createNode reference -n "BookcaseRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"BookcaseRN" 0
		"BookcaseRN" 2
		2 "|Bookcase:Shelf" "translate" " -type \"double3\" -0.067870802874061553 0 0"
...
createNode reference -n "Potted_Plant_wo_CurvesRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Potted_Plant_wo_Curves:Pot" "translate" " -type \"double3\" -3.03586394707185381 2.60067145788507981 7.94011246507204671"
