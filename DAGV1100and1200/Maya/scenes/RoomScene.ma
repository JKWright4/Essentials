...
//Name: RoomScene.ma
//Last modified: Tue, Mar 24, 2026 11:16:23 PM
//Codeset: 1252
...
fileInfo "UUID" "9701E7C4-4192-8446-0512-FE97D84CC9D1";
createNode transform -s -n "persp";
	rename -uid "2340ED71-4C42-971C-62FE-75A5C06857A7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 34.405595495351776 26.598994493269313 34.726232418961629 ;
	setAttr ".r" -type "double3" -20.40000000000127 -317.59999999997933 2.153518639846833e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 51.210514953674831;
...
createNode fosterParent -n "BookcaseRNfosterParent1";
	rename -uid "76A69BBB-4CDC-2149-55AD-BA8AA0180AB5";
createNode mesh -n "Bookcase:polySurfaceShape2" -p "BookcaseRNfosterParent1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F248EA91-451D-9154-CFEE-269B5A4C09B9";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "69FA0C7B-4640-4E65-E54A-7E8B5F76F79B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BC665012-492E-129F-1E5D-16918F86BBCC";
createNode displayLayerManager -n "layerManager";
	rename -uid "790A59DB-4DF8-0F42-504D-88AB1FEF2DC5";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "16EFEFEB-4987-C3D5-BF51-58A70C9723DC";
...
createNode reference -n "BookcaseRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"-na"
		"BookcaseRN" 21
		0 "|BookcaseRNfosterParent1|Bookcase:polySurfaceShape2" "|Bookcase:Shelf" 
		"-s -r "
...
createNode reference -n "sofaRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|sofa:sofa|sofa:loftedSurface3" "rotate" " -type \"double3\" 7.8930780629059667 1.02420663450376592 -2.06632647091344968"
		...
		2 "|sofa:sofa|sofa:pillow" "rotate" " -type \"double3\" 229.15088275224769632 28.57193820512802063 112.68996906359146237"
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "5F3E3701-4565-A932-6022-C5884F6CF00D";
...
connectAttr "Bookcase:polySurfaceShape2.o" "polyCloseBorder1.ip";
